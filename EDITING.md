...
| **Page covers & extra blocks** | Each page's cover photo, colour/black-and-white effect, crop, credit and additional text/image/video blocks |
...
3. Select a **Cover image**. It appears on both the project index and its detail page. Add an image description and optional caption. Choose **Project cover fitting**: `contain` shows the whole image; `cover` fills the frame and may crop it. Set the crop position if needed. Replace the illustrative cover and its caption when you have your own render.
...
Under **Extra content blocks**, add a heading and formatted text, then optionally select an image or video. Choose the image/text alignment and drag blocks to reorder. These blocks appear below that page's main content. This works on Home, Projects, Experience, Leadership, Education, Awards, Skills, Gallery, Updates and Contact. Individual project pages have their own **Project story blocks**; individual Updates use the **Your post** editor.
...
## Homepage, branding and theme controls
